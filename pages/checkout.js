  ...
  return (
    <Layout>
        ...
        <div className="flex mb-5 items-center" key={productInfo._id}>
          ...
          <div className="pl-4 items-center">
            ...
            <div className="flex mt-1">
              <div className="grow font-bold">Rs{productInfo.price}</div>
              <div>
      ...
      <form action="/api/checkout" method="POST">
        ...
        <button type="submit" className="bg-emerald-500 px-5 py-2 rounded-xl font-bold text-white w-full my-4 shadow-emerald-300 shadow-lg">Pay Rs.{total}</button>
      </form>
    </Layout>
  );
}
